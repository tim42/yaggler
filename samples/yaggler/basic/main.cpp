...
constexpr neam::string_t vert = "samples_data/shaders/shader_test.vert";
constexpr neam::string_t frag = "samples_data/shaders/shader_test.frag";

constexpr neam::string_t yaggler_logo = "samples_data/textures/yaggler-w.png";
constexpr neam::string_t bg_image = "samples_data/textures/bg.png";
...
int main(int argc, char **argv)
{
  ...
  neam::yaggler::shader::program<neam::yaggler::type::opengl,
       neam::yaggler::shader::shader // The fragment shader
       <
        neam::yaggler::type::opengl, neam::embed::GLenum<GL_FRAGMENT_SHADER>,
        neam::yaggler::shader::shader_loader<neam::yaggler::shader::file, neam::embed::string<frag>>,
       ...
       >,
       neam::yaggler::shader::shader // The vertex shader
       <
        neam::yaggler::type::opengl, neam::embed::GLenum<GL_VERTEX_SHADER>,
        neam::yaggler::shader::shader_loader<neam::yaggler::shader::file, neam::embed::string<vert>>,
        neam::embed::shader::option<neam::yaggler::shader::shader_option::reload_on_change>,
        neam::yaggler::shader::shader_env<neam::yaggler::shader::no_env>
       >
  > prog;
  ...
  float rm_step = 55.;
  prog.get_shader_at_index<0>().environment.append_to_additional_strings("#define RM_STEP " + static_cast<std::ostringstream&>(std::ostringstream() << rm_step).str()); // base define
  ...
  while (!win.should_close())
  {
    ...
    // get windows size, convert it to fixed position (to get it work with the shaders)
